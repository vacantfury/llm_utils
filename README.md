...
| Anthropic | `ANTHROPIC_API_KEY` (and `LLM_UTILS_ALLOW_CLAUDE_API=1`: Anthropic API calls are opt-in per process, since v8.0.0; other Claude routes are not covered since v8.1.0) |
